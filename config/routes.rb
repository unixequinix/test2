...
#                                                          /cable                                                                                            #<ActionCable::Server::Base:0x007fbea6d9e060 @mutex=#<Monitor:0x007fbea6d9e038 @mon_owner=nil, @mon_count=0, @mon_mutex=#<Thread::Mutex:0x007fbea6d9dfe8>>, @pubsub=nil, @worker_pool=nil, @event_loop=nil, @remote_connections=nil>
