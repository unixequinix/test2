module AnalyticsHelper
  ...
  def raw_data_money
    CSV.generate do |csv|
      csv << ['Action', 'Description', 'Payment Method', 'Event Day', 'Date Time', 'Date', 'Location', 'Station Type', 'Station Name', 'Customer UID', 'Customer Name', 'Operator UID', 'Operator Name', 'Device', 'Money', 'Number of Operations']
      data = %w[action description payment_method event_day date_time date location station_type station_name customer_uid customer_name operator_uid operator_name device_name money num_operations]
