class Ticket < ApplicationRecord
  ...
  ransacker :purchaser_name do |parent|
    Arel::Nodes::NamedFunction.new('CONCAT_WS', [Arel::Nodes.build_quoted(' '), parent.table[:purchaser_first_name], parent.table[:purchaser_last_name]])
  end
