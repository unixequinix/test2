module Admins
  module Events
    class BizzaboController < Admins::Events::BaseController
      protect_from_forgery
      before_action :set_integration

      def index
        redirect_to(%i[admins bizzabo auth]) && return unless @token
      ...
      def set_integration
        @integration = @current_event.bizzabo_ticketing_integrations.find(params[:ticketing_integration_id])
