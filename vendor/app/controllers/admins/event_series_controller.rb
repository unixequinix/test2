  ...
  class EventSeriesController < BaseController
    ...
    def copy_serie
      ...
      if old_event == new_event
        ...
        Creators::EventSerieJob.perform_later(new_event, old_event, copy_params[:customers].split(" "), copy_params[:gtags], copy_params[:orders], copy_params[:fees])
    ...
    def copy_params
      params.require(:copy_data).permit(:gtags, :orders, :customers, :fees, :new_id, :old_id)
    end
  end
end
