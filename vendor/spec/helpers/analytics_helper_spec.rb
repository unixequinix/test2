  ...
  describe "test for analytics helper used in standard and custom reports" do
    ...
    context "should return money" do
      ...
      it "should have correct fields" do
        expect(pokes_money.first.keys).to match_array(%w[id action description customer_id payment_method date date_time customer_uid customer_name operator_uid operator_name device_name location station_type station_name money num_operations event_day])
      end
    ...
    context "should return money simplified" do
      ...
      it "should have correct fields" do
        expect(pokes_money_simple.last.keys).to match_array(%w[id customer_id action source description operator_uid operator_name device_name location station_type station_name event_day date_time date payment_method num_operations money])
      end
    end
