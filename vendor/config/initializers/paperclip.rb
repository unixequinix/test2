...
Paperclip.interpolates :default_event_image_url do |attachment, style|
  ActionController::Base.helpers.asset_url('glownet-event-logo.png')
end

Paperclip.interpolates :default_user_avatar_url do |attachment, style|
  ActionController::Base.helpers.asset_url('default_user_avatar.png')
end

Paperclip.interpolates :default_event_background_url do |attachment, style|
  ActionController::Base.helpers.asset_url('background-default.jpg')
end
