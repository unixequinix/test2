...
RSpec.describe Profile, type: :model do
  ...
  describe ".recalculate_balance" do
    context "with multiple online transactions for one purchase" do
      before do
        @transaction = create(:credit_transaction, profile: profile,
    ...
    context "with record credit being last" do
      before do
        @online_topup = create(:credit_transaction,
                               profile: profile,
                               transaction_type: "online_topup",
                               credits: 10,
                               refundable_credits: 5,
        ...
        @onsite_topup = create(:credit_transaction,
                               ...
                               credits: 15,
                               refundable_credits: 15,
                               credit_value: 1,
                               final_balance: 15,
                               final_refundable_balance: 15,
                               gtag_counter: 1)
        @record_credit = create(:credit_transaction,
                                profile: profile,
                                transaction_type: "record_credit",
                                credits: 10,
                                refundable_credits: 5,
                                credit_value: 1,
                                final_balance: 25,
