class Api::V1::Events::UserFlagsController < Api::V1::Events::BaseController
  ...
  def index
    ...
    user_flags = ActiveModelSerializers::Adapter.create(user_flags.map { |a| Api::V1::UserFlagSerializer.new(a) }).to_json if user_flags.present? # rubocop:disable Metrics/LineLength
