class Api::V1::Events::AccessesController < Api::V1::Events::BaseController
  ...
  def index
    ...
    accesses = ActiveModelSerializers::Adapter.create(accesses.map { |a| Api::V1::AccessSerializer.new(a) }).to_json if accesses.present? # rubocop:disable Metrics/LineLength
