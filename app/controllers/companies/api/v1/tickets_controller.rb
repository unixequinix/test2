module Companies::Api
  class V1::TicketsController < Companies::Api::BaseController
    def index
      render json: {
        event_id: @current_event.id,
        tickets: tickets.map { |ticket| Companies::TicketSerializer.new(ticket) }
      }
    end
    ...
    def show
      ...
      if @ticket
        render json: @ticket, serializer: Companies::TicketSerializer
      else
    ...
    def create
      ...
      render(status: :created, json: Companies::TicketSerializer.new(@ticket))
    end
