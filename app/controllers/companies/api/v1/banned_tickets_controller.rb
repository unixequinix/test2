module Companies::Api
  class V1::BannedTicketsController < Companies::Api::BaseController
    def index
      render json: {
        event_id: @current_event.id,
        blacklisted_tickets: banned_tickets.map do |ticket|
          Companies::TicketSerializer.new(ticket)
        end
      }
    end
    ...
    def create # rubocop:disable Metrics/PerceivedComplexity
      ...
      render(status: :created, json: @ticket, serializer: Companies::TicketSerializer)
    end
