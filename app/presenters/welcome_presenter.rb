class WelcomePresenter < BasePresenter
  ...
  def render_credentiable_links
    ...
    sep = context.content_tag(:span, t("registration.new.or"), class: "buttons-separator")
  ...
  def render_description
    ...
    t("sessions.first_register.description_without_credentiable")
  end
  ...
  def generate_button(button)
    ...
    context.link_to(t("dashboard.first_register.#{button}"), path, class: css + " cb-add_#{button}")
  end
end
