class TicketingIntegration < ApplicationRecord
  NAMES = { eventbrite: "TicketingIntegrationEventbrite", universe: "TicketingIntegrationUniverse", palco4: "TicketingIntegrationPalco4", qwantiq: "TicketingIntegrationQwantiq" }.freeze
