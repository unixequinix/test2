class OperatorPermission < CatalogItem
  ...
  validates :role, uniqueness: { scope: %i[event_id group station_id], message: (->(object, _data) { "This role has already been used for #{'group ' + object.group if object.group}#{'station ' + object.station.name if object.station}" }) }
