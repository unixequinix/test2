class Refund < ApplicationRecord
  ...
  scope :online_refund_credits, lambda {
    select("'fee' as action, 'refund_online' as description, 'online' as source", dimensions_station, event_day_refund, date_time_refund, "'c' as credit_name, NULL as device_name", "-1 * sum(credit_base) as credit_amount")
      .completed
  ...
  scope :online_refund_fee, lambda {
    select(transaction_type_refund, dimensions_station, event_day_refund, date_time_refund, "'c' as credit_name, NULL as device_name", "-1 * sum(credit_fee) as credit_amount")
      .completed
      .group(grouper_transaction_type, grouper_dimensions_station, grouper_event_day, grouper_date_time, "device_name")
  }
  ...
  def self.credit_refund
    "-1 * sum(credit_base + credit_fee) as credit_amount"
  end
