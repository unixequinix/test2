module Api::V2
  class Full::StatSerializer < ActiveModel::Serializer
    attributes %i[action name operation_id origin date event_id event_name line_counter device_id device_mac device_name station_id station_type
                  ...
                  product_id product_name is_alcohol sale_item_quantity sale_item_unit_price catalog_item_id catalog_item_name catalog_item_type
                  payment_method monetary_quantity monetary_unit_price currency monetary_total_price credit_id credit_name credit_value credit_amount
                  order_id message priority user_flag_value access_direction]
  end
end
