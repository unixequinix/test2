...
ActiveRecord::Schema.define(version: 20150421164407) do
  ...
  create_table "ticket_types", force: :cascade do |t|
    t.integer  "entitlement_id", index: {name: "fk__ticket_types_entitlement_id"}, foreign_key: {references: "entitlements", name: "fk_ticket_types_entitlement_id", on_update: :no_action, on_delete: :no_action}
    t.string   "name"
    t.string   "company"
