...
ActiveRecord::Schema.define(version: 20160224122200) do
  ...
  create_table "customers", force: :cascade do |t|
    t.integer  "event_id",               index: {name: "fk__customers_event_id"}, foreign_key: {references: "events", name: "fk_customers_event_id", on_update: :no_action, on_delete: :no_action}
  ...
  create_table "company_ticket_types", force: :cascade do |t|
    ...
    t.integer  "company_event_agreement_id", index: {name: "fk__company_ticket_types_company_event_agreement_id"}, foreign_key: {references: "company_event_agreements", name: "fk_company_ticket_types_company_event_agreement_id", on_update: :no_action, on_delete: :no_action}
    t.string   "name"
  ...
  create_table "gtags", force: :cascade do |t|
    ...
    t.integer  "company_ticket_type_id", null: false, index: {name: "fk__gtags_company_ticket_type_id"}, foreign_key: {references: "company_ticket_types", name: "fk_gtags_company_ticket_type_id", on_update: :no_action, on_delete: :no_action}
  ...
  create_table "catalog_items_packs", force: :cascade do |t|
    ...
    t.integer  "amount"
    t.datetime "deleted_at",      index: {name: "index_catalog_items_packs_on_deleted_at"}
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
  end
  ...
  create_table "customer_orders", force: :cascade do |t|
    t.integer  "customer_event_profile_id", index: {name: "fk__customer_orders_customer_event_profile_id"}, foreign_key: {references: "customer_event_profiles", name: "fk_customer_orders_customer_event_profile_id", on_update: :no_action, on_delete: :no_action}
    t.integer  "catalog_item_id",           index: {name: "fk__customer_orders_catalog_item_id"}, foreign_key: {references: "catalog_items", name: "fk_customer_orders_catalog_item_id", on_update: :no_action, on_delete: :no_action}
    t.integer  "counter"
  ...
  create_table "event_parameters", force: :cascade do |t|
    t.string   "value",        default: "", null: false
    t.integer  "event_id",     index: {name: "fk__event_parameters_event_id"}, foreign_key: {references: "events", name: "fk_event_parameters_event_id", on_update: :no_action, on_delete: :no_action}
    t.integer  "parameter_id", index: {name: "fk__event_parameters_parameter_id"}, foreign_key: {references: "parameters", name: "fk_event_parameters_parameter_id", on_update: :no_action, on_delete: :no_action}
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
  end
