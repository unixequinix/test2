...
ActiveRecord::Schema.define(version: 20170103104816) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "iban_enabled",                 default: true
  end
  ...
  add_index "station_parameters", ["station_id"], name: "index_station_parameters_on_station_id", using: :btree
  ...
  create_table "ticket_types", force: :cascade do |t|
    t.integer  "event_id"
    t.integer  "company_event_agreement_id"
    t.string   "name"
  ...
  add_foreign_key "station_parameters", "stations"
