namespace :redshift do
  ...
  task export: :environment do
    ...
    end_index = ARGV[2].to_i.zero? ? EventLog.count : ARGV[3].to_i
    ...
    EventLog.find_in_batches(start: start_index, batch_size: batch_size).with_index  do |events, batch|
      batch += 1
    ...
    EventLog.where(id: ids).delete_all
    puts "Done"
