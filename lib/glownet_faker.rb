class GlownetFaker
  ...
  def tickets
    logger.info " -- creating #{@amount} tickets for current ticket types"
  ...
  def gtags
    logger.info " -- creating #{@amount} gtags for current event"
  ...
  def customers
    logger.info " -- creating #{@amount} customers"
  ...
  def orders
    logger.info " -- creating one order per customer for current customers"
