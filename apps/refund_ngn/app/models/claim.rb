...
class Claim < ActiveRecord::Base
  ...
  scope :query_for_csv, lambda  { |aasm_state, event|
    joins(:customer_event_profile, :gtag, :refund, customer_event_profile: :customer)
      ...
      .select("claims.id, customer_event_profiles.id as customer_event_profile, customers.first_name,
            customers.last_name, customers.email, gtags.tag_uid, gtags.tag_serial_number,
