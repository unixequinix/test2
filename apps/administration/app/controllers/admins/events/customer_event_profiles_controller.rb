class Admins::Events::CustomerEventProfilesController < Admins::Events::BaseController
  ...
  def show
    @customer_event_profile =
      @fetcher.customer_event_profiles.with_deleted.includes(
        ...
        :credential_assignments_gtag_assigned).find(params[:id])
  end
  ...
  def set_presenter
    @list_model_presenter = ListModelPresenter.new(
      ...
      include_for_all_items: [:customer, :credential_assignments_tickets_assigned, :credential_assignments_gtag_assigned]
    )
  end
end
