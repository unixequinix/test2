class UltralightCForm
  include ActiveModel::Model
  include Virtus.model

  attribute :ultralight_c_private_key, String
  ...
  validates :ultralight_c_private_key, format: { with: /\A[0-9A-F]+\z/,
  ...
  def persist!
    Parameter.where(category: "gtag", group: "ultralight_c").each do |parameter|
